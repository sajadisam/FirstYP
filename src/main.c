...
int main(int argv, char** args){
   ...
   /**/ SDL_Surface *pSurface = IMG_Load("resources/hejsan.png");
    ...
    //pTexture = IMG_LoadTexture("resources/NightBorne.png", pRenderer);
    ...
    while(!closeWindow){
        ...
        playerPosition.x += playerVelocityX / 40; // Adjust SPEED definition to be float for smooth movement
       ...
       SDL_RenderCopy(pRenderer, pTexture, &playerRect, &playerPosition); // Render the current frame
       if(newImageVisible) {
